  ...
  <div class="landing-page">
    ...
    <section class="hero">
      ...
      <div class="container hero-content">
        <div class="hero-wrap">
          <h2 class="hero-title">Manage Your Tickets Effortlessly</h2>
          <p class="hero-subtitle">
           Ticketly helps you organize, track, and resolve issues faster. Streamline your workflow with our intuitive ticket management system.
          </p>
          <div class="hero-buttons">
            <router-link to="/auth/signup" class="btn btn-primary btn-lg"
              >Get Started</router-link
            >
            <router-link to="/auth/login" class="btn btn-outline btn-lg">Log In</router-link>
          </div>
    ...
    <section class="cta-section">
      <div class="container text-center">
        ...
        <router-link to="/auth/signup" class="btn-primary"> Create Your Account </router-link>
      </div>
    </section>
    ...
    <footer class="footer">
      <div class="container">
        <div class="footer-grid">
          <div>
            <h4 class="footer-title">Ticketly</h4>
            <p class="footer-text">Modern ticket management for teams.</p>
          </div>
